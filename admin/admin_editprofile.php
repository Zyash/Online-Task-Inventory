...
}else
{
	...
	<title>Edit Profile | WORKFLOW</title>
  ...
  <div id="containerHolder">
    <div id="container">
      ...
      <!-- h2 stays for breadcrumbs -->
        <h2>Accounts &raquo; <a href="#" class="active"> Edit Profile</a></h2><br />  
        ...
        <div id="main">
            ...
            <form name="empreg" id="empreg" method="post" action="action/edit-profile.php" onMouseOver="check_emp_email(document.getElementById('txtemail').value);" onMouseOut=" check_emp_phone(document.getElementById('txtphone').value);">
			<table class="table">
            <?php 
			/*if(isset($_REQUEST["q"]))
			{*/
            ...
            <tr>
            	<td colspan="2" align="center">
                	<input type="submit" name="btnsave" value="Update" class="button-submit" />
                </td>
            </tr>
            </table>
            </form>
